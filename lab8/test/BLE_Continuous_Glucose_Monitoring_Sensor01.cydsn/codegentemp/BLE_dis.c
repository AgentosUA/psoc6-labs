...
{
    0x0025u,    /* Handle of the DIS service */
    {
        0x0027u, /* Handle of the Manufacturer Name String characteristic */ 
        0x0029u, /* Handle of the Model Number String characteristic */ 
        CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the Serial Number String characteristic */ 
        0x002Bu, /* Handle of the Hardware Revision String characteristic */ 
