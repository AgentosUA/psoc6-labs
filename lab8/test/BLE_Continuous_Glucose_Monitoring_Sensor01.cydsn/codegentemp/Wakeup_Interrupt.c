...
{
    #ifdef Wakeup_Interrupt_INTERRUPT_INTERRUPT_CALLBACK
        Wakeup_Interrupt_Interrupt_InterruptCallback();
    #endif /* Wakeup_Interrupt_INTERRUPT_INTERRUPT_CALLBACK */ 
...
*
*   Note calling Wakeup_Interrupt_Start or Wakeup_Interrupt_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after Wakeup_Interrupt_Start or Wakeup_Interrupt_StartEx has been called. 
