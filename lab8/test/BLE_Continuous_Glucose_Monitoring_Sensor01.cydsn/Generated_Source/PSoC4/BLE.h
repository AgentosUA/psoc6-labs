...
#define CYBLE_GAP_ROLE_BROADCASTER                  (0u != (CYBLE_GAP_ROLE & CYBLE_GAP_BROADCASTER))
    ...
    #define CYBLE_GAPP_CONNECTION_TIME_OUT          (0x0C80u)
    ...
    #define CYBLE_GAPC_CONNECTION_INTERVAL_MAX      (0x0020u)
    #define CYBLE_GAPC_CONNECTION_SLAVE_LATENCY     (0x0000u)
    #define CYBLE_GAPC_CONNECTION_TIME_OUT          (0x000Au)
...
*/
#define CYBLE_IO_CAPABILITY                         (CYBLE_GAP_IOCAP_KEYBOARD_ONLY)
...
#define CYBLE_ADV_PKT_INDEX_SERVICE_UUID_16   (0x1Bu)

#define CYBLE_SCN_PKT_INDEX_SERVICE_UUID_16   (0x00u)
#define CYBLE_SCN_PKT_INDEX_APPEARANCE   (0x08u)
