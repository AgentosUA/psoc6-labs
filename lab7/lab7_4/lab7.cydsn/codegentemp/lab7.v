...
module SCB_UART_PDL_v2_0_1 (
	...
	cy_clock_v1_0
		#(.id("f3a8a84c-ddef-47bc-9734-4890a79060e4/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("f3a8a84c-ddef-47bc-9734-4890a79060e4/65f3af6c-759b-4ccb-8c66-5c95ba1f5f4f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("f3a8a84c-ddef-47bc-9734-4890a79060e4/b7e8018e-1ef7-49c0-b5a5-61641a03e31c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("1"),
...
module top ;
    ...
    cy_annotation_universal_v1_0 P6_VDD (
        .connect({
            Net_15
        })
    );
    defparam P6_VDD.comp_name = "Power_v1_0";
    defparam P6_VDD.port_names = "T1";
    defparam P6_VDD.width = 1;
	...
	cy_mxs40_gpio_v1_0
		#(.id("be5e4883-575c-41fb-bc37-1a78e01b9698"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("2"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("e29eb476-8372-4bbf-8809-7fcbdcff6cc5"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("2"),
		  .ibuf_enabled("0"),
