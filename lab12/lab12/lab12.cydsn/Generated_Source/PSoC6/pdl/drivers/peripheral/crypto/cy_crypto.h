...
*
* The Crypto driver (both client and server) is provided as precompiled binary
...
*
f* \section group_crypto_definitions Definitions
*
...
*
* \param ivPtr
* The pointer to the initial vector. Must be 4-Byte aligned.
*
* \param dst
* The pointer to a destination cipher text. Must be 4-Byte aligned.
*
* \param src
...
*
* \param nonceCounter
* The 128-bit nonce and counter. Must be 4-Byte aligned.
*
* \param streamBlock
...
*
* \param message
* The pointer to the message to be processed. Must be 4-Byte aligned.
*
* \param messageSize
