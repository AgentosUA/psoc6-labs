...
// TCPWM_Counter_PDL_v1_0(CaptureInput=0, CaptureInputMasked=0, ClockPrescaler=0, Compare0=16384, Compare1=16384, CompareOrCapture=2, CountDirection=0, CountInput=7, CountInputMasked=3, EnableCompareSwap=false, InterruptSource=0, Period=32768, ReloadInput=1, ReloadInputMasked=1, Resolution=16, RunMode=0, StartInput=0, StartInputMasked=0, StopInput=1, StopInputMasked=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_Counter_PDL_v1_0, CY_CONFIG_TITLE=Timer_Echo, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_Echo, CY_INSTANCE_SHORT_NAME=Timer_Echo, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Timer_Echo, )
...
module SCB_UART_PDL_v2_0_2 (
	...
	cy_clock_v1_0
		#(.id("057d60ec-067c-40cc-a6ba-001fa1256dd2/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("057d60ec-067c-40cc-a6ba-001fa1256dd2/65f3af6c-759b-4ccb-8c66-5c95ba1f5f4f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("057d60ec-067c-40cc-a6ba-001fa1256dd2/b7e8018e-1ef7-49c0-b5a5-61641a03e31c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("1"),
...
module top ;
    ...
    TCPWM_PWM_PDL_v1_0_0 PWM_Trigger (
        .kill(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	cy_clock_v1_0
		#(.id("530ac3c3-031a-4c04-a2f1-0dcf77a5ef97"),
	...
	cy_clock_v1_0
		#(.id("2eb4faf4-a846-46b9-8f70-df9d0b51a328"),
		  .source_clock_id("2FB4EC85-8328-4C5A-9ED9-8B63060178EB"),
		  .divisor(0),
    ...
    TCPWM_Counter_PDL_v1_0_1 Timer_Echo (
        .stop(Net_61),
        .reload(Net_61),
        .start(Net_61),
        .count(1'b1),
	...
	wire [0:0] tmpIO_0__Pin_US_Echo_net;
	electrical [0:0] tmpSIOVREF__Pin_US_Echo_net;
	...
	cy_mxs40_gpio_v1_0
		...
		Pin_US_Echo
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({Net_61}),
		  .io({tmpIO_0__Pin_US_Echo_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_US_Echo_net));
