...
module top ;
	...
	wire [6:0] tmpFB_6__Port7_net;
	wire [6:0] tmpIO_6__Port7_net;
	electrical [0:0] tmpSIOVREF__Port7_net;
	...
	cy_mxs40_gpio_v1_0
		...
		Port7
		 (.oe({7'b1111111}),
		  .y({7'b0}),
		  .fb({tmpFB_6__Port7_net[6:0]}),
		  .io({tmpIO_6__Port7_net[6:0]}),
		  .siovref(tmpSIOVREF__Port7_net));
