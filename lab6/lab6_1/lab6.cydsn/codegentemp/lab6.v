...
module top ;
	...
	wire [0:0] tmpFB_0__KIT_LED_BLUE_net;
	wire [0:0] tmpIO_0__KIT_LED_BLUE_net;
	electrical [0:0] tmpSIOVREF__KIT_LED_BLUE_net;

	cy_mxs40_gpio_v1_0
		#(.id("cc837c40-430c-4b93-a838-3394b772e92d"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
		...
		KIT_LED_BLUE
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__KIT_LED_BLUE_net[0:0]}),
		  .io({tmpIO_0__KIT_LED_BLUE_net[0:0]}),
		  .siovref(tmpSIOVREF__KIT_LED_BLUE_net),
		  .annotation({Net_68}));
